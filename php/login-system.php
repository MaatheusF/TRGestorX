...
$pg_query_login = "SELECT usua_codigo, usua_login, usua_rank, usua_nome, usua_email FROM usua_usuario uu WHERE usua_login = '{$post_user_name}' AND usua_senha = '{$post_user_pass}'";
