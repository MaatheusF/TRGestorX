<?php
# Busca e Salva os Clientes associados ao Usuario Logado na Tela de Configurações
...
# Busca os Clientes Cadastrados no Banco de Dados, e Ativa os que estão associados
function BuscaClientes(){
    ...
    $pg_query_listaclientes = "select cc.cli_nome,cc.cli_codigo from cli_clientes cc";  //Busca todos os Clientes Cadastrados na cli_codigo
...
# Salva as Alterações realizadas nos Clientes Associados
function SalvaClientes($clientes){
    ...
    foreach ($clientes as $valor) {
        $pg_query_insert = "INSERT INTO public.acg_associa_cliente_gestor(acg_cli_cliente_codigo, acg_usua_codigo_gestor)
